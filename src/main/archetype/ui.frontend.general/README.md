...
* `npm run dev:live` - Runs webpack and aemsync in watch mode pushing changes directly to AEM. CSS and JS changes are automatically reflected on any local AEM page opened (JS changes cause a page refresh)
...
${hash}${hash}${hash} Configuration file

...
* [core:](core/README.md) Java bundle containing all core functionality like OSGi services, background processing jobs, as well as component-related Java code such as servlets or request filters.
...
* [ui.frontend:](ui.frontend.general/README.md) an optional dedicated front-end build mechanism (general Webpack project)

...
if (includeForms == "n") {
    ...
    assert new File("$confFolder/settings/cloudconfigs/fdm/ms-dynamics-odata-cloud-service").deleteDir()
    assert new File("$confFolder/settings/cloudconfigs/fdm/salesforce-cloud-service").deleteDir()
